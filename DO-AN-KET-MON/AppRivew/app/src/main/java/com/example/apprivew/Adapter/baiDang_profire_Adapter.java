...
public class baiDang_profire_Adapter extends RecyclerView.Adapter<baiDang_profire_Adapter.BaiDangViewHolder> {

    private Context context;

    private List<Item_BaiDang> listBaiDang;

    public baiDang_profire_Adapter(Context context, List<Item_BaiDang> listBaiDang) {
    ...
    public void onBindViewHolder(@NonNull BaiDangViewHolder holder, int position) {
        ...
        if(baiDang == null)
        {
            ...
            holder.cardViewItemBaiDang.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View view) {
                    onClickLongSua(baiDang);
                    return false;
                }
            });
...
//                @Override
//                public boolean onLongClick(View view) {
//                    onClickLongPostDetails(baiDang);
//                    return false;
//                }
//            });
        }
...
//    public void onClickLongPostDetails(Item_BaiDang baiDang)
//    {
//        Intent intent = new Intent(context, suaBaiViet.class);
//        Bundle bundle = new Bundle();
//        bundle.putSerializable("object_BaiDangSua", baiDang);
//        intent.putExtras(bundle);
//        context.startActivity(intent);
//    }
    public void onClickLongSua(Item_BaiDang baiDang)
    {
